...
use falcon::fpr::{fpr_add as add, fpr_div as div, fpr_double as double,
                  fpr_half as half, fpr_inv as inv, fpr_lt as lt,
                  fpr_mul as mul, fpr_neg as neg, fpr_rint as rint,
                  fpr_sqrt as sqrt, fpr_sub as sub, fpr_trunc as trunc,
                    fpr_floor as floor, fpr_expm_p63 as expm_p63};
