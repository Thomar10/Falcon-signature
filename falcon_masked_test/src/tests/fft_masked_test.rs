...
mod tests {
    ...
    use falcon_masked::fft_masked::{fft, fpc_add, fpc_mul, fpc_sub, ifft, poly_add, poly_neg, poly_sub};
    use falcon::fft::{fpc_add as u_fpc_add, fpc_mul as u_fpc_mul, fpc_sub as u_fpc_sub, fft as u_fft, ifft as u_ifft, poly_add as u_poly_add, poly_sub as u_poly_sub, poly_neg as u_poly_neg};
