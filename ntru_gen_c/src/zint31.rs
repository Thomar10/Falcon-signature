...
extern "C" {
    ...
    pub fn ntrugen_zint_norm(x: *const u32, len: usize, xstride: usize, p: *const u32);
    pub fn ntrugen_zint_rebuild_CRT(xx: *const u32, xlen: usize, n: usize, num_sets: usize, normalize_signed: bool, tmp: *const u32);
