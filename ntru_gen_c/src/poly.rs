...
extern "C" {
    ...
    //pub fn ntrugen_poly_mp_set(logn: u32, f: *const i8, p: u32);
    //pub fn ntrugen_poly_mp_norm(logn: u32, f: *const i8, p: u32);
    ...
    //pub fn ntrugen_poly_big_to_fixed(logn: u32, d: *const fxr, f: *const u32, len: usize, sc: u32);
}
