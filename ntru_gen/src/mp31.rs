...
pub fn mp_mkgm7(gm: &mut [u32], g: u32, p: u32, p0i: u32) {
    let n = 128;
    let k = 3;
    let mut x1 = mp_r(p);
    for u in 0usize..n {
...
pub fn mp_ntt(logn: u32, a: &mut [u32], gm: &[u32], p: u32, p0i: u32) {
    ...
    let mut t: usize = 1 << logn as usize;
    for lm in 0usize..logn as usize {
        let m: usize = 1 << lm;
        let ht = t >> 1;
        let mut v0: usize = 0;
        for u in 0..m {
...
pub fn mp_intt(logn: u32, a: &mut [u32], igm: &[u32], p: u32, p0i: u32) {
    ...
    let mut t: usize = 1;
    for lm in 0usize..logn as usize {
        let hm: usize = 1 << (logn as usize - 1 - lm);
        let dt = t << 1;
        let mut v0: usize = 0;
        for u in 0..hm {
            let s = igm[u + hm];
...
#[inline(always)]
fn mp_sub(a: u32, b: u32, p: u32) -> u32 {
