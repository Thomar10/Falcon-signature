...
use falcon::{falcon_privatekey_size, falcon_publickey_size, falcon_sig_compressed_maxsize, falcon_tmpsize_keygen, falcon_tmpsize_signdyn, falcon_tmpsize_verify};
use falcon::falcon::{falcon_keygen_make, FALCON_SIG_COMPRESS, falcon_sign_dyn, falcon_verify};
...
criterion_group!(benches, vrfy_9,  vrfy_10);
