...
use falcon::{falcon_privatekey_size, falcon_publickey_size, falcon_sig_compressed_maxsize, falcon_tmpsize_expanded_key_size, falcon_tmpsize_expandprivate, falcon_tmpsize_keygen, falcon_tmpsize_signdyn, falcon_tmpsize_signtree};
use falcon::falcon::{falcon_expand_privatekey, falcon_keygen_make, FALCON_SIG_COMPRESS, falcon_sign_dyn, falcon_sign_tree};
...
criterion_group!(benches, sign_dyn_9,  sign_dyn_10,  sign_tree_9,  sign_tree_10, expand_key_9, expand_key_10);
