...
mod tests {
    ...
    use falcon_c::shake_c::{falcon_inner_i_shake256_extract, falcon_inner_i_shake256_flip, falcon_inner_i_shake256_init, falcon_inner_i_shake256_inject, InnerShake256Context as InnerShake256ContextC, process_block as process_block_c, St as StC};
