...
mod tests {
    ...
    use falcon_c::codec_c::{falcon_inner_comp_decode, falcon_inner_comp_encode, falcon_inner_modq_decode, falcon_inner_modq_encode, falcon_inner_trim_i16_decode, falcon_inner_trim_i16_encode, falcon_inner_trim_i8_decode, falcon_inner_trim_i8_encode};
