pub fn fpr_norm64(mut m: u64, mut e: i32) -> (u64, i32) {
    let mut nt: u32;
    e -= 63;
...
pub fn fpr_add_inter(mut x: u64, mut y: u64) -> (u64, u64, u64, u64, u64, u64, u32, i32, i32, i32, i32, i32) {
    ...
    (m,  xu, yu, za, x, y, cs, ex, ey, sx, sy, cc)
}
